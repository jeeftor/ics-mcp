...
func ToolInfos() []ToolInfo {
	return []ToolInfo{
		{Name: "upcoming_meetings", Description: "List ongoing and upcoming meetings by time. Compact output is default; pass detail=full for verbose fields, fields=[...] for explicit structured fields, or format=tg-text, tg-html, or tg-markdownv2 for Telegram-ready text. Descriptions are opt-in. Supports window presets, sort, include_links, links_only, and explicit disabled-calendar opt-in.", Category: "read", ReadOnly: true, InputExample: `{"limit":10,"window":"","lookahead_days":30,"timezone":"","query":"","format":"","fields":["when","title","calendar","duration","duration_minutes","ongoing","all_day","cancelled","recurring"],"sort":"start_time","in_progress_only":false,"exclude_all_day":false,"exclude_cancelled":true,"include_description":false,"include_links":true,"links_only":false,"include_disabled":false}`, DefaultArguments: map[string]any{"limit": 10, "window": "", "lookahead_days": 30, "timezone": "", "query": "", "format": "", "fields": []string{"when", "title", "calendar", "duration", "duration_minutes", "ongoing", "all_day", "cancelled", "recurring"}, "sort": "start_time", "in_progress_only": false, "exclude_all_day": false, "exclude_cancelled": true, "include_description": false, "include_links": true, "links_only": false, "include_disabled": false}},
		{Name: "upcoming_meetings_by_calendar", Description: "List ongoing and upcoming meetings grouped by calendar. Compact output is default; limit applies per calendar. Sort applies within each calendar group. Use fields=[...] to choose structured meeting fields or format=tg-text, tg-html, or tg-markdownv2 for Telegram-ready text.", Category: "read", ReadOnly: true, InputExample: `{"limit":10,"window":"","lookahead_days":30,"timezone":"","query":"","format":"","fields":["when","title","calendar","duration","duration_minutes","ongoing","all_day","cancelled","recurring"],"sort":"start_time","exclude_cancelled":true,"include_description":false,"include_links":true,"include_disabled":false}`, DefaultArguments: map[string]any{"limit": 10, "window": "", "lookahead_days": 30, "timezone": "", "query": "", "format": "", "fields": []string{"when", "title", "calendar", "duration", "duration_minutes", "ongoing", "all_day", "cancelled", "recurring"}, "sort": "start_time", "exclude_cancelled": true, "include_description": false, "include_links": true, "include_disabled": false}},
		{Name: "next_meeting", Description: "Return the next non-all-day, non-cancelled meeting. Use fields=[...] for explicit structured fields or format=tg-text, tg-html, or tg-markdownv2 for Telegram-ready text.", Category: "read", ReadOnly: true, InputExample: `{"timezone":"","format":"","fields":["when","title","calendar","duration","duration_minutes","ongoing","all_day","cancelled","recurring"],"include_links":true,"include_disabled":false}`, DefaultArguments: map[string]any{"timezone": "", "format": "", "fields": []string{"when", "title", "calendar", "duration", "duration_minutes", "ongoing", "all_day", "cancelled", "recurring"}, "include_links": true, "include_disabled": false}},
		{Name: "next_meetings", Description: "List upcoming meeting-focused events, excluding all-day and cancelled events, using compact output by default. Use fields=[...] for explicit structured fields or format=tg-text, tg-html, or tg-markdownv2 for Telegram-ready text.", Category: "read", ReadOnly: true, InputExample: `{"limit":10,"window":"","lookahead_days":30,"timezone":"","format":"","fields":["when","title","calendar","duration","duration_minutes","ongoing","all_day","cancelled","recurring"],"sort":"start_time","include_description":false,"include_links":true,"include_disabled":false}`, DefaultArguments: map[string]any{"limit": 10, "window": "", "lookahead_days": 30, "timezone": "", "format": "", "fields": []string{"when", "title", "calendar", "duration", "duration_minutes", "ongoing", "all_day", "cancelled", "recurring"}, "sort": "start_time", "include_description": false, "include_links": true, "include_disabled": false}},
		{Name: "today_meetings", Description: "List meetings that overlap the current display day. Includes today's timed meetings, today's all-day blocks, and ongoing multi-day events, but ignores broader window/day/range presets so tomorrow and later events are not returned. Defaults to agenda sort: ongoing timed meetings, upcoming timed meetings, then all-day or multi-day blocks. Use fields=[...] for explicit structured fields or format=tg-text, tg-html, or tg-markdownv2 for Telegram-ready text.", Category: "read", ReadOnly: true, InputExample: `{"timezone":"","format":"","fields":["when","title","calendar","duration","duration_minutes","ongoing","all_day","cancelled","recurring"],"sort":"agenda","include_description":false,"include_links":true,"include_disabled":false}`, DefaultArguments: map[string]any{"timezone": "", "format": "", "fields": []string{"when", "title", "calendar", "duration", "duration_minutes", "ongoing", "all_day", "cancelled", "recurring"}, "sort": "agenda", "include_description": false, "include_links": true, "include_disabled": false}},
		{Name: "current_meetings", Description: "List meetings currently in progress. Use fields=[...] for explicit structured fields or format=tg-text, tg-html, or tg-markdownv2 for Telegram-ready text.", Category: "read", ReadOnly: true, InputExample: `{"format":"","fields":["when","title","calendar","duration","duration_minutes","ongoing","all_day","cancelled","recurring"],"exclude_all_day":true,"exclude_cancelled":true,"include_disabled":false}`, DefaultArguments: map[string]any{"format": "", "fields": []string{"when", "title", "calendar", "duration", "duration_minutes", "ongoing", "all_day", "cancelled", "recurring"}, "exclude_all_day": true, "exclude_cancelled": true, "include_disabled": false}},
		{Name: "search_meetings", Description: "Search cached ongoing and upcoming meetings by title, calendar name, or cached description. Descriptions remain omitted from output unless include_description is true. Use fields=[...] for explicit structured fields or format=tg-text, tg-html, or tg-markdownv2 for Telegram-ready text.", Category: "read", ReadOnly: true, InputExample: `{"query":"planning","limit":10,"window":"","format":"","fields":["when","title","calendar","duration","duration_minutes","ongoing","all_day","cancelled","recurring"],"sort":"start_time","exclude_cancelled":true,"include_links":true,"include_disabled":false}`, DefaultArguments: map[string]any{"query": "", "limit": 10, "window": "", "format": "", "fields": []string{"when", "title", "calendar", "duration", "duration_minutes", "ongoing", "all_day", "cancelled", "recurring"}, "sort": "start_time", "exclude_cancelled": true, "include_links": true, "include_disabled": false}},
		{Name: "free_busy", Description: "List busy blocks without meeting titles or descriptions. Use window or after and before for a specific availability window. Use fields=[...] for explicit busy-block fields or format=tg-text, tg-html, or tg-markdownv2 for Telegram-ready text.", Category: "read", ReadOnly: true, InputExample: `{"window":"today_tomorrow","after":"2026-06-30T15:00:00Z","before":"2026-07-01T00:00:00Z","limit":20,"format":"","fields":["when","calendar","duration","duration_minutes"],"exclude_cancelled":true,"sort":"start_time","include_disabled":false}`, DefaultArguments: map[string]any{"window": "today", "limit": 20, "format": "", "fields": []string{"when", "calendar", "duration", "duration_minutes"}, "exclude_cancelled": true, "sort": "start_time", "include_disabled": false}},
